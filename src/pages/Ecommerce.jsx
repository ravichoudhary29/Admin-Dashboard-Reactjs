    ...
    return (
        <div className="mt-12">
            <div className=" flex flex-wrap lg:flex-nowrap justify-center">
                <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-120 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-contain bg-center">
                    <div className="flex flex-col justify-between  content-start">
                        <p className="font-bold text-gray-400">Earnings</p>
                        <p className="text-2xl">$67,890.50</p>
                    </div>
                    <div className="mt-6">
                        <Button
                            color="white"
